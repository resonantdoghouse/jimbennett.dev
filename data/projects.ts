...
export const projects: Project[] = [
  ...
  },
  {
    ...
    longDescription: "An interactive virtual piano built with React, capable of playing MIDI-like song data with synchronized visual feedback. It splits left and right-hand parts, illuminating keys in real-time. Showcases precise timing handling in JavaScript and performant DOM updates for musical applications.",
  ...
  },
  {
    ...
    longDescription: "A 3D visualization experiment using Three.js to render terrain from heightmap data. It utilizes custom WebGL shaders for texture mapping and lighting, providing a performant and interactive 3D environment in the browser. Highlights skills in graphics programming and 3D math.",
  ...
  },
  {
    ...
    longDescription: "A procedural terrain generator utilizing Perlin noise algorithms to create organic, infinite landscapes. Built with p5.js, it demonstrates an understanding of algorithmic generation, mathematical visualizations, and canvas rendering performance.",
  ...
  {
    id: "codepen-challenges",
    title: "CodePen Challenges & Experiments",
    slug: "codepen-challenges",
    description: "A collection of creative coding challenges, mostly focused on advanced CSS/SCSS with some JavaScript. Some of these have been featured as CodePen challenges.",
    longDescription: "A collection of advanced frontend demonstrations focusing on CSS3 triggers, complex keyframe animations, and experimental UI patterns. These experiments push the boundaries of browser rendering engines and serve as a playground for modern interaction design.",
    tech: ["CSS", "SCSS", "JavaScript"],
    link: "https://codepen.io/jimbennett",
    images: ["/assets/portfolio/codepen.jpg"]
  }
];
