      ...
      <div className="max-w-[1100px] mx-auto px-5">
        <nav className="flex justify-between items-center" role="navigation" aria-label="Main Navigation">
          ...
          <ul className="hidden md:flex gap-8 items-center list-none">
            <li><NavLink href="#quests">Quests (Work)</NavLink></li>
            <li><NavLink href="#levels">Levels (Projects)</NavLink></li>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="md:hidden">
              <Button variant="icon" onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}>
